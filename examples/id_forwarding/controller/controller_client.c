...
#define CLIENT_CONTROL_PORT 9090
#define SERVER_CONTROL_PORT 9091

#define CONTROLLER_SERVER_ADDR "10.0.2.2"
#define CONTROLLER_SERVER_PORT 10000

#define ETH_HDR_SIZE 14
#define UDP_HDR_SIZE 8
#define MSG_SIZE 256

//char msg2[45]="08000000022208000000011108000000011108000000:";
...
int main(int argc, char* argv[])
{
	...
	while (1) {
        ...
        if (ntohs(udp_hdr->src_port) != CLIENT_CONTROL_PORT
        || ntohs(udp_hdr->dst_port) != SERVER_CONTROL_PORT) {
        ...
        //extract message
        msg += UDP_HDR_SIZE;
        printf("Received UDP message from (%d.%d.%d.%d:%d) msg = %s\n",
